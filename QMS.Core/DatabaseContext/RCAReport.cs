...
{
    [Table("tbl_RCA_Report")]
    public class RCAReport : SqlTable
    {
        //-----------------------------------
        // SqlTable override
        //-----------------------------------
        ...
        public List<RCAReportDetail>? Details { get; set; }

    }

    [Table("tbl_RCA_Report_Details")]
    public class RCAReportDetail : SqlTable
    {
        //-----------------------------------
        // SqlTable override
        //-----------------------------------
        ...
        [ForeignKey("Rca_Id")]
        public RCAReport? RCAReport { get; set; }
    }
}
