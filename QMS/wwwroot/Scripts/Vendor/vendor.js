...
function OnTabGridLoad(response) {
    ...
    if (response.length > 0) {
        ...
        columns.push(
            ...
            { title: "User Name", field: "User_Name", headerMenu: headerMenu, headerFilter: "input", hozAlign: "center", headerHozAlign: "center" },
            { title: "Password", field: "Password", headerMenu: headerMenu, headerFilter: "input", hozAlign: "center", headerHozAlign: "center" },
