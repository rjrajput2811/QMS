...
var DashboardSparklines = function() {
    ...
    return {
        init: function() {
            ...
            _chartSparkline('#new-visitors_1', 'line', 30, 35, 'basis', 750, 2000, '#26A69A');
            _chartSparkline('#new-sessions_1', 'line', 30, 35, 'basis', 750, 2000, '#FF7043');
            _chartSparkline('#total-online_1', 'line', 30, 35, 'basis', 750, 2000, '#5C6BC0');
